...
import { isoToMinutes, isoToTime, timeToISO, PIXELS_PER_MINUTE, TOP_MARGIN, SHOW_CARD_TITLE_HEIGHT, SHOW_CARD_TIME_HEIGHT } from '../utils/utils';
...
export const TaskCard = ({ card, isDragging, getTagColor, onPress, onClick, layout }: TaskCardProps) => {
