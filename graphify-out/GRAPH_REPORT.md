...
- [[_COMMUNITY_getDatabase()  DatabaseMaintenanceService  .clearAllData()|getDatabase() / DatabaseMaintenanceService / .clearAllData()]]
- [[_COMMUNITY_Button.stories.ts  Button.tsx  Header.stories.ts|Button.stories.ts / Button.tsx / Header.stories.ts]]
- [[_COMMUNITY_CapacitorDatabaseService  .constructor()  .execute()|CapacitorDatabaseService / .constructor() / .execute()]]
- [[_COMMUNITY_changes  initDb()  rows|changes / initDb() / rows]]
- [[_COMMUNITY_CompositeTypes  Constants  Database|CompositeTypes / Constants / Database]]
- [[_COMMUNITY_createRoutineCard()  routine-expansion.test.ts  routine-expansion.ts|createRoutineCard() / routine-expansion.test.ts / routine-expansion.ts]]
- [[_COMMUNITY_disableTransitionsTemporarily()  getSystemTheme()  isEditableTarget()|disableTransitionsTemporarily() / getSystemTheme() / isEditableTarget()]]
- [[_COMMUNITY_Auth Component  Auth State Type  Auth Store Hook|Auth Component / Auth State Type / Auth Store Hook]]
- [[_COMMUNITY_App Component  Root Component  RoutineTimeTrackerService|App Component / Root Component / RoutineTimeTrackerService]]
- [[_COMMUNITY_build.gradle  capacitor.build.gradle  build.gradle|build.gradle / capacitor.build.gradle / build.gradle]]
- [[_COMMUNITY_WebDatabaseService  .constructor()  .execute()|WebDatabaseService / .constructor() / .execute()]]
- [[_COMMUNITY_Capacitor Mobile Configuration  Main Entry HTML  Android Main Activity|Capacitor Mobile Configuration / Main Entry HTML / Android Main Activity]]
- [[_COMMUNITY_RoutineTimeTrackerService  .ensureStateRecord()  .initialize()|RoutineTimeTrackerService / .ensureStateRecord() / .initialize()]]
- [[_COMMUNITY_CapacitorDatabaseService  DatabaseServiceFactory  initDb|CapacitorDatabaseService / DatabaseServiceFactory / initDb]]
- [[_COMMUNITY_DatabaseMaintenanceService  getDatabase  supabase|DatabaseMaintenanceService / getDatabase / supabase]]
- [[_COMMUNITY_Storybook Configuration  Figma Plugin Screenshot  GitHub Logo|Storybook Configuration / Figma Plugin Screenshot / GitHub Logo]]
- [[_COMMUNITY_Routine Cards Table Definition  Routine Tags Table Definition  Routine Recurrence Logic|Routine Cards Table Definition / Routine Tags Table Definition / Routine Recurrence Logic]]
- [[_COMMUNITY_ExampleInstrumentedTest.java  ExampleInstrumentedTest  .useAppContext()|ExampleInstrumentedTest.java / ExampleInstrumentedTest / .useAppContext()]]
- [[_COMMUNITY_ExampleUnitTest.java  ExampleUnitTest  .addition_isCorrect()|ExampleUnitTest.java / ExampleUnitTest / .addition_isCorrect()]]
...
- [[_COMMUNITY_Example Unit Test|Example Unit Test]]
- [[_COMMUNITY_SQLite3 Worker Promiser|SQLite3 Worker Promiser]]
- [[_COMMUNITY_Vite Logo|Vite Logo]]
- [[_COMMUNITY_Android Splash Screen|Android Splash Screen]]
- [[_COMMUNITY_Android App Icon|Android App Icon]]
- [[_COMMUNITY_Tauri App Icon|Tauri App Icon]]
- [[_COMMUNITY_Initialization Sequence Rationale|Initialization Sequence Rationale]]
- [[_COMMUNITY_Square 30x30 Logo|Square 30x30 Logo]]
- [[_COMMUNITY_Square 150x150 Logo|Square 150x150 Logo]]
- [[_COMMUNITY_Store Logo|Store Logo]]
- [[_COMMUNITY_Square 107x107 Logo|Square 107x107 Logo]]
...
- [[_COMMUNITY_128x128 App Icon|128x128 App Icon]]
- [[_COMMUNITY_Square 284x284 Logo|Square 284x284 Logo]]
- [[_COMMUNITY_32x32 App Icon|32x32 App Icon]]
- [[_COMMUNITY_Square 44x44 Logo|Square 44x44 Logo]]
- [[_COMMUNITY_Square 71x71 Logo|Square 71x71 Logo]]
- [[_COMMUNITY_128x128@2x App Icon|128x128@2x App Icon]]
- [[_COMMUNITY_React Logo|React Logo]]
- [[_COMMUNITY_DateNavigator|DateNavigator]]
- [[_COMMUNITY_TimeTrackerActionButton|TimeTrackerActionButton]]
- [[_COMMUNITY_TimeTrackerCard Model|TimeTrackerCard Model]]
- [[_COMMUNITY_RoutineCard Model|RoutineCard Model]]
- [[_COMMUNITY_Drag Store Signals|Drag Store Signals]]
- [[_COMMUNITY_Overlap-aware Layout Algorithm|Overlap-aware Layout Algorithm]]
- [[_COMMUNITY_useSettingsStore|useSettingsStore]]
- [[_COMMUNITY_cn|cn]]
- [[_COMMUNITY_isSupabaseConfigured|isSupabaseConfigured]]
- [[_COMMUNITY_BaseModel|BaseModel]]
- [[_COMMUNITY_ModelConfig|ModelConfig]]
- [[_COMMUNITY_Seed Authentication Users|Seed Authentication Users]]
- [[_COMMUNITY_Seed Routine Tags|Seed Routine Tags]]
- [[_COMMUNITY_RLS Auto Enable Function|RLS Auto Enable Function]]
- [[_COMMUNITY_Storybook Tutorials Icon|Storybook Tutorials Icon]]
- [[_COMMUNITY_YouTube Social Icon|YouTube Social Icon]]
- [[_COMMUNITY_Discord Community Icon|Discord Community Icon]]
...
- **Routine Tracker UI Components** — routinetimetrackerwidget_routinetimetrackerwidget, taskcard_taskcard, currenttimeindicator_currenttimeindicator, timelinegrid_timelinegrid, savechangedialog_savechangedialog [EXTRACTED]
- **Routine Management Subsystem** — routinecard_model, routineeditor_routineeditor, routine_expansion_logic, routine_exception_mechanism [INFERRED 0.85]
- **Visual Layout Subsystem** — layout_algorithm, drag_store_signals, timetrackeractionbutton_timetrackeractionbutton [INFERRED 0.80]
- **Local-First Database Abstraction** — db_types_idatabaseservice, sqlite_getdatabase, tauri_sqlite_tauridatabaseservice, capacitor_sqlite_capacitordatabaseservice, web_sqlite_webdatabaseservice [EXTRACTED]
